...
export const projectsData = [
  {
    ...
    longDescription: 'A production-style commerce integration POC — the kind of proof-of-concept a Solutions Engineer builds to show a prospect exactly how a platform solves their operational problem.',
  ...
  },
  {
    ...
    longDescription: 'A portfolio-grade Solutions Engineering project that turns deployment events into one release health snapshot — instead of four tabs to check after every deploy.',
