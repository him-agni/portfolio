...
- Starting baseline commit for the latest change set: `825d42f` (`Add engineering notes for featured projects`)
- Production site: <https://him-agni.github.io/portfolio/>
- Repository: <https://github.com/him-agni/portfolio>
- Latest change set: aligned the hero, About, Projects, and Contact copy around Solutions Engineering; added a public email contact; moved the two general development projects into a compact “Other Builds” section; added SEO/social metadata, written demo transcripts, and a Solutions Engineer-focused README.
...
- `src/components/Projects.jsx` renders the four slug-based projects as the featured grid and non-slug entries as compact “Other Builds” cards.
...
GitHub Stats Tracker and Personal Finance Tracker appear in the smaller “Other Builds” section and use direct demo/source links.
...
- Replace `public/resume.pdf` with the Solutions Engineer-focused resume when the user provides it; the existing Hero link will pick up the replacement automatically.
...
- Only the SaaS Integration Hub and Release Intelligence projects have demo videos and written transcripts. The other two deliberately render “Demo coming soon.”
